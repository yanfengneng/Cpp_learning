...
参考：[理解 C/C++ 中的左值和右值](https://nettee.github.io/posts/2018/Understanding-lvalues-and-rvalues-in-C-and-C/)、[一文读懂C++右值引用和std::move](https://zhuanlan.zhihu.com/p/335994370)
